...
I am a technology enthusiast focused on building a strong foundation in software development, especially in backend engineering, databases, Python automation, and clean programming practices.

My goal is to keep improving through practical projects, consistent study, and real problem solving. I enjoy turning ideas into useful solutions, learning how systems work behind the scenes, and writing code that is clear, maintainable, and easy to evolve.

- Currently studying **Java**, **Python**, and **Databases**
- Focused on **Backend Development** and solid programming fundamentals
- Interested in **Clean Architecture**, **Design Patterns**, and best practices
- Exploring **data**, **automation**, and practical problem solving with code
...
```text
Backend fundamentals       REST APIs, business rules, validations, error handling
Databases                  SQL modeling, queries, relationships, and data integrity
Python automation          Scripts, workflows, data handling, and productivity tools
Software quality           Clean code, testing mindset, maintainability, and Git workflow
```
